  ...
  const self = {
    ...
    _populateUsernameColor: () => {
      ...
      self.elements.username_color_select.empty().append(
        ...
        hasAllDonatorColors || hasPermForColor('donator.gay') ? crel('option', { value: -17, class: 'donator donator--gay' }, '*. Donator Gay') : null,
        hasAllDonatorColors || hasPermForColor('donator.lesbian') ? crel('option', { value: -18, class: 'donator donator--lesbian' }, '*. Donator Lesbian') : null,
